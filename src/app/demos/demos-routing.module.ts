...
const routes: Routes = [
  ...
  { path: 'daniru', loadChildren: 'app/demos/daniru/daniru.module#DaniruModule', data: { title: 'My website' } },
  { path: 'tfl', loadChildren: 'app/demos/tfl/tfl.module#TflModule', data: { title: 'Transport For London' } },
  { path: 'ngblog', loadChildren: 'app/demos/ngblog/ngblog.module#NgblogModule', data: { title: 'Create your own Angular Blog' } },
